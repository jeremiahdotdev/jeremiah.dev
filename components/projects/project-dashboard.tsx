    ...
    return (
        <>
            <div className="hidden h-page-content max-h-page-content w-full flex-1 flex-col overflow-hidden rounded-md border border-border bg-dashboard shadow-inner lg:flex">
                <div className="flex min-h-14 items-center justify-between gap-4 border-b border-border bg-dashboard-header p-4 shadow-xl">
            ...
            <div className="relative flex h-page-content max-h-page-content w-full flex-1 flex-col justify-center overflow-hidden lg:hidden">
