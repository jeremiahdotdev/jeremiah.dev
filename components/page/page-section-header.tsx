...
const PageSectionHeader: FC<PageSectionHeaderProps> = ({children}: PageSectionHeaderProps) => {
    ...
    const header = useMemo(() => (
        <h1 className={"p-4 flex flex-col text-2xl w-full font-serif font-thin tracking-widest text-foreground/80 items-center justify-center sm:justify-end sm:align-start sm:px-16"}>
            {children}
        </h1>
    ), [children]);
